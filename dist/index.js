...
const isomorphic_unfetch_1 = __importDefault(__nccwpck_require__(203));
const sign_1 = __nccwpck_require__(670);
...
class DingBot {
    ...
    async rawSend(msg) {
        ...
        const r = await (0, isomorphic_unfetch_1.default)(this.buildUrl(), {
            method: 'POST',
            body,
            headers: {
    ...
    buildUrl() {
        ...
        if (this.options.signKey) {
            ...
            const sign = (0, sign_1.createSign)(this.options.signKey, ts);
...
module.exports = global.fetch = global.fetch || (
	typeof process=='undefined' ? r(__nccwpck_require__(814)) : (function(url, opts) {
		return r(__nccwpck_require__(513))(String(url).replace(/^\/\//g,'https://'), opts);
	})
);
...
var whatwgUrl = _interopDefault(__nccwpck_require__(186));
...
var mappingTable = __nccwpck_require__(136);
...
const usm = __nccwpck_require__(25);
...
const conversions = __nccwpck_require__(152);
const utils = __nccwpck_require__(303);
const Impl = __nccwpck_require__(902);
...
exports.URL = __nccwpck_require__(987).interface;
exports.serializeURL = __nccwpck_require__(25).serializeURL;
exports.serializeURLOrigin = __nccwpck_require__(25).serializeURLOrigin;
exports.basicURLParse = __nccwpck_require__(25).basicURLParse;
exports.setTheUsername = __nccwpck_require__(25).setTheUsername;
exports.setThePassword = __nccwpck_require__(25).setThePassword;
exports.serializeHost = __nccwpck_require__(25).serializeHost;
exports.serializeInteger = __nccwpck_require__(25).serializeInteger;
exports.parseURL = __nccwpck_require__(25).parseURL;
...
const tr46 = __nccwpck_require__(341);
...
const ding_bot_1 = __nccwpck_require__(591);
const endpoint = 'https://oapi.dingtalk.com/robot/send';
function run() {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
